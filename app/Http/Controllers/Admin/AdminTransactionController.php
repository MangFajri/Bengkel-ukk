...
class AdminTransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Logic Penentuan Customer & Kendaraan
    ...
    public function update(Request $request, Transaction $transaction)
    {
        ...
        ActivityLog::record(
            ...
            [
                'service_status' => "{$oldServiceStatus} -> " . ($transaction->serviceStatus->label ?? '-'),
                'payment_status' => "{$oldPaymentStatus} -> " . ($transaction->paymentStatus->label ?? '-'),
                'mechanic_id' => $request->mechanic_id,
            ]
        );
    ...
    {
        $transaction->load([
            'customer', 'vehicle', 'mechanic', 'paymentMethod',
            'services' => function ($q) { $q->withTrashed(); },
            'spareParts' => function ($q) { $q->withTrashed(); },
        ]);
