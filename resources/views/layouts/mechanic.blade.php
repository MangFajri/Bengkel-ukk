...
<head>
    ...
    <meta name="description" content="Mechanic Area">
    <meta name="author" content="FajriGarage">

    <title>@yield('title', 'Mechanic Area') - FajriGarage</title>
...
<body id="page-top">
    <div id="wrapper">
        @include('layouts.partials.mechanic-sidebar')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: #1e293b; color: white; border: 1px solid #334155;">
                <div class="modal-header" style="border-bottom: 1px solid #334155;">
                    <h5 class="modal-title text-warning" id="exampleModalLabel">Konfirmasi Logout</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="color: white;">×</span>
                    </button>
                </div>
                <div class="modal-body">Apakah Anda yakin ingin mengakhiri sesi kerja ini?</div>
