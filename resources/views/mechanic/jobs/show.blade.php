            ...
            <div class="card shadow mb-4" style="background-color: #1e293b; border: 1px solid #334155;">
                ...
                <div class="card-body">
                    ...
                    <div class="p-3 rounded mb-3" style="background-color: #0f172a; border-left: 4px solid #f6c23e;">
                        ...
                        <p class="text-white mb-0 font-italic">"{{ $transaction->notes ?? 'Tidak ada catatan khusus.' }}"</p>
                    </div>
                    ...
                    <ul class="list-group list-group-flush" style="background-color: transparent;">
                        @forelse($transaction->services as $service)
                            <li class="list-group-item d-flex justify-content-between align-items-center text-white" style="background-color: transparent; border-color: #334155;">
                                <div>
                        ...
                        @empty
                            <li class="list-group-item text-muted bg-transparent border-0">Tidak ada jasa khusus (Cek keluhan).</li>
                        @endforelse
                    </ul>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('mechanic.jobs.updateStatus', $transaction->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="service_status_id" class="form-control text-white" style="background-color: #0f172a; border: 1px solid #334155;">
