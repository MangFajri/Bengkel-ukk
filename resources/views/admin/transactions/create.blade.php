        ...
        <div class="col-lg-10">
            <div class="card shadow mb-4" style="background-color: #1e293b; border: 1px solid #334155;">
                <div class="card-header py-3 d-flex justify-content-between align-items-center"
                    ...
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase">Formulir Masuk Bengkel (Walk-In & Booking)
                    </h6>
                ...
                <div class="card-body text-white">
                    ...
                    <form action="{{ route('admin.transactions.store') }}" method="POST">
                        ...
                        <div id="section-existing" class="p-4 rounded mb-4 border border-primary"
                            style="background-color: #0f172a;">
                            <h6 class="text-primary font-weight-bold mb-3"><i class="fas fa-user-check mr-2"></i>Cari Data
                                Pelanggan</h6>
                            ...
                            <div class="form-group">
                                ...
                                {{-- Tambahkan ID --}}
                                <select name="vehicle_id" id="selectVehicle" class="form-control"
                                    style="background-color: #1e293b; color: white;">
                        ...
                        <div id="section-walkin" class="p-4 rounded mb-4 border border-success d-none"
                            style="background-color: #0f172a;">
                            <h6 class="text-success font-weight-bold mb-3"><i class="fas fa-user-plus mr-2"></i>Input
                                Pelanggan Walk-In</h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="new_phone"
                                            class="form-control bg-dark text-white border-secondary" placeholder="08xxxxx">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="new_plate_number"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="new_brand"
                                            class="form-control bg-dark text-white border-secondary" placeholder="Honda">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="p-4 rounded mb-4 border border-secondary" style="background-color: #0f172a;">
                            <h6 class="text-warning font-weight-bold mb-3"><i class="fas fa-tools mr-2"></i>Detail
                                Pengerjaan & Mekanik</h6>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" class="form-control bg-dark text-white border-secondary" rows="2"
                                    placeholder="Contoh: Service rutin + ganti oli"></textarea>
                            </div>
                                    ...
                                    @foreach($services as $service)
                                        <div class="col-md-6">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="svc-{{ $service->id }}"
                                                    name="service_ids[]" value="{{ $service->id }}">
                                                <label class="custom-control-label" for="svc-{{ $service->id }}">
                                                    {{ $service->name }} <span class="badge badge-dark ml-2">Rp
                        ...
                        <div class="p-4 rounded mb-4 border border-info" style="background-color: #0f172a;">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 class="text-info font-weight-bold m-0"><i class="fas fa-cogs mr-2"></i>Penggunaan
                                    Sparepart (Opsional)</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-dark" id="sparepartTable"
                                    style="background-color: #1e293b;">
                                    <thead>
                                        <tr>
